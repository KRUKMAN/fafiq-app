-- Calendar events aggregation RPC (medical, transports, dynamic quarantine)
-- Quarantine duration derives from orgs.settings.quarantine_days (default 14).
-- Security: active org membership required unless service_role.
