...
const activityEventsList: ActivityEvent[] = [
  activityEventSchema.parse({
    ...
    entity_type: 'dog',
    entity_id: '1',
    event_type: 'dog.stage_changed',
    summary: 'Stage changed to In Foster',
  ...
  activityEventSchema.parse({
    id: 'evt_5',
    org_id: 'org_123',
    created_at: '2025-12-17T19:10:00Z',
    actor_user_id: 'user_123',
    actor_membership_id: 'm_org123_user123',
    entity_type: 'dog',
    entity_id: '1',
    event_type: 'dog.note_added',
    summary: 'Added note about leash training progress',
    payload: { note: 'Responds well to short walks twice a day.' },
    related: {},
  }),
  activityEventSchema.parse({
    id: 'evt_6',
    org_id: 'org_123',
    created_at: '2025-12-17T20:05:00Z',
    actor_user_id: 'user_123',
    actor_membership_id: 'm_org123_user123',
    entity_type: 'dog',
    entity_id: '1',
    event_type: 'dog.foster_assigned',
    summary: 'Assigned foster Sarah Johnson',
    payload: { foster: 'Sarah Johnson' },
    related: {},
  }),
  activityEventSchema.parse({
    id: 'evt_7',
    ...
    entity_type: 'dog',
    entity_id: '2',
    event_type: 'dog.file_uploaded',
    summary: 'Uploaded surgery discharge PDF',
    payload: { file: 'Surgery discharge.pdf' },
    related: {},
  }),
];
